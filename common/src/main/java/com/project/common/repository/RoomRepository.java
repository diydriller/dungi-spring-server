...
public interface RoomRepository extends CrudRepository<Room,Long> {
    ...
    @Query("select r from Room r join r.userRoomList ur join ur.user u " +
            "where u.id=:id and ur.deleteStatus=:status")
    Page<Room> findAllRoomByUserAndDeleteStatus(@Param("id") Long id,
